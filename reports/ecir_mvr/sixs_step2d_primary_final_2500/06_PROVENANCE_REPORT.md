...
provenance metadata and is not an eligibility gate. The recovered legacy exact union is fully contained in the existing canonical TRAIN exclusion, so no exclusion membership is added and the identity-only freeze may proceed.
